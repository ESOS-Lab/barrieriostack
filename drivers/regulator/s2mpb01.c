	...
	struct s2mpb01_platform_data *pdata)
{
	...
	/* Temp variables : Disable BUCK1 for Zero Rev0.0 */
	u8 reg = S2MPB01_REG_BUCK_CTRL;
	u8 shift = 6;
	u8 mask = 0x03;
	...
	/* Disable BUCK1 for Zero Rev0.0 */
	s2mpb01_update_reg(s2mpb01->i2c, reg, ((~mask) << shift), (mask << shift));
