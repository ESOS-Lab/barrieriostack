...
static const unsigned char SEQ_TSET[] = {
	0xB8,
	/* Global para(8th) + 25 degrees  : 0x19 */
...
static const unsigned char SEQ_HMT_DUAL1[] = {
	/* G.Param */
	0xB0, 0x01
};

static const unsigned char SEQ_HMT_DUAL2[] = {
	/* Display Line : 2560 -> 1264, porch : 16 -> 32 */
	0xF2, 0x00, 0x01, 0xA4, 0x05, 0x1B, 0x4F
};

static const unsigned char SEQ_HMT_DUAL3[] = {
	/* GRAM Window Vertical Set : 2559(9FF) -> 1279(4FF) */
	0x2B, 0x00, 0x00, 0x04, 0xFF
};

static const unsigned char SEQ_HMT_DUAL4[] = {
	/* G.Param */
	0xB0, 0x01
};

static const unsigned char SEQ_HMT_DUAL5[] = {
	/* Display Line Setting Enable */
	0xF2, 0x04
};

static const unsigned char SEQ_HMT_SINGLE1[] = {
	/* G.Param */
	0xB0, 0x01
};

static const unsigned char SEQ_HMT_SINGLE2[] = {
	/* Display Line : 1264 -> 2560, porch : 32 -> 16 */
	0xF2, 0x00, 0x01, 0xA4, 0x05, 0x0B, 0xA0
};

static const unsigned char SEQ_HMT_SINGLE3[] = {
	/* GRAM Window Vertical Set : 1279(4FF) -> 2559(9FF) */
	0x2B, 0x00, 0x00, 0x09, 0xFF
};

static const unsigned char SEQ_HMT_SINGLE4[] = {
	/* G.Param */
	0xB0, 0x01
};

static const unsigned char SEQ_HMT_SINGLE5[] = {
	/* Display Line Setting Enable */
	0xF2, 0x04
};
