	...
	u32 channel)
{
	...
	case 0:
		...
		fimc_is_enable_dt(pdev, "gate_pclk_csis0");
		fimc_is_enable_dt(pdev, "gate_aclk_fimc_bns_a");
		fimc_is_enable_dt(pdev, "gate_pclk_fimc_bns_a");
		break;
	case 1:
		fimc_is_enable_dt(pdev, "gate_aclk_csis1_i_wrap");
		fimc_is_enable_dt(pdev, "gate_pclk_csis1");
		fimc_is_enable_dt(pdev, "gate_aclk_fimc_bns_b");
		fimc_is_enable_dt(pdev, "gate_pclk_fimc_bns_b");
		break;
	case 2:
		fimc_is_enable_dt(pdev, "gate_aclk_csis2");
		fimc_is_enable_dt(pdev, "gate_pclk_csis2");
		fimc_is_enable_dt(pdev, "gate_aclk_fimc_bns_c");
		fimc_is_enable_dt(pdev, "gate_pclk_fimc_bns_c");
		break;
	default:
		pr_err("channel is invalid(%d)\n", channel);
		break;
	...
	u32 channel)
{
	...
	switch (channel) {
	case 0:
		fimc_is_disable_dt(pdev, "gate_aclk_csis0_i_wrap");
		fimc_is_disable_dt(pdev, "gate_pclk_csis0");
		fimc_is_disable_dt(pdev, "gate_aclk_fimc_bns_a");
		fimc_is_disable_dt(pdev, "gate_pclk_fimc_bns_a");
		break;
	case 1:
		fimc_is_disable_dt(pdev, "gate_aclk_csis1_i_wrap");
		fimc_is_disable_dt(pdev, "gate_pclk_csis1");
		fimc_is_disable_dt(pdev, "gate_aclk_fimc_bns_b");
		fimc_is_disable_dt(pdev, "gate_pclk_fimc_bns_b");
		break;
	case 2:
		fimc_is_disable_dt(pdev, "gate_aclk_csis2");
		fimc_is_disable_dt(pdev, "gate_pclk_csis2");
		fimc_is_disable_dt(pdev, "gate_aclk_fimc_bns_c");
		fimc_is_disable_dt(pdev, "gate_pclk_fimc_bns_c");
		break;
	default:
		pr_err("channel is invalid(%d)\n", channel);
		break;
