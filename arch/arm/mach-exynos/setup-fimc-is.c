...
int exynos7420_cfg_clk_div_max(struct platform_device *pdev)
{
	/* CAM0 */
	/* USER_MUX_SEL */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_csis0_690", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_bnsa_690", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_bnsb_690", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_bnsd_690", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_csis1_174", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_3aa0_690", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_3aa1_468", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_trex_532", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_nocp_133", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs0_s2a", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs0_s4", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs1_s4", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs2_s4", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs3_s4", "oscclk");
	/* BNS A */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_bnsa_345", 1);
	/* BNS B */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_bnsb_345", 1);
	/* BNS D */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_bnsd_345", 1);
	/* 3AA0 */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_3aa0_345", 1);
	/* 3AA1 */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_3aa1_234", 1);
	/* TREX */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_trex_266", 1);
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_trex_133", 1);

	/* CAM1 */
	/* USER_MUX_SEL */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_sclvra_491", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_arm_668", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_busperi_334", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_bnscsis_133", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_nocp_133", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_trex_532", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_hs0_csis2_rx_byte", "oscclk");
	/* SCLK_SPI */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_sclk_isp_spi0", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_sclk_isp_spi1", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_sclk_isp_uart", "oscclk");
	/* VRA */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam1_sclvra_246", 1);
	/* ARM */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam1_arm_167", 1);
	/* CAM1 BUSPERI */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam1_busperi_167", 1);
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam1_busperi_84", 1);

	/* ISP0 */
	/* USER_MUX_SEL */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_isp0_isp0_590", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_isp0_tpu_590", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_isp0_trex_532", "oscclk");
	/* ISP */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_isp0_isp0_295", 1);
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_isp0_trex_266", 1);
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_isp0_trex_133", 1);
	/* TPU */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_isp0_tpu_295", 1);

	/* ISP1 */
	/* USER_MUX_SEL */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_isp1_isp1_468", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_isp1_ahb_117", "oscclk");
	/* ISP */
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_isp1_isp1_234", 1);

	return 0;
}

int exynos7420_cfg_clk_sclk(struct platform_device *pdev)
{
	/* SCLK_SPI1 */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_sclk_isp_spi0", "sclk_isp_spi0");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_sclk_isp_spi1", "sclk_isp_spi1");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_sclk_isp_uart", "sclk_isp_uart");

	return 0;
}

int exynos7420_cfg_clk_cam0(struct platform_device *pdev)
{
#if 0
	/* CSIS0 */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_csis0_690", "aclk_cam0_csis0_690");

	/* BNS A */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_bnsa_690", "aclk_cam0_bnsa_690");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_bnsa_345", 345 * 1000000);

	/* BNS B */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_bnsb_690", "aclk_cam0_bnsb_690");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_bnsb_345", 345 * 1000000);

	/* BNS D */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_bnsd_690", "aclk_cam0_bnsd_690");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_bnsd_345", 345 * 1000000);

	/* CSIS1 */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_csis1_174", "aclk_cam0_csis1_174");

	/* 3AA0 */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_3aa0_690", "aclk_cam0_3aa0_690");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_3aa0_345", 345 * 1000000);

	/* 3AA1 */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_3aa1_468", "aclk_cam0_3aa1_468");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_3aa1_234", 234 * 1000000);

	/* TREX */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_trex_532", "aclk_cam0_trex_532");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_trex_266", 266 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_trex_133", 133 * 1000000);
#else
	pr_info("start \n");
	/* CSIS0 */
	fimc_is_enable_dt(pdev, "gate_aclk_csis0_i_wrap");

	/* BNS A */
	fimc_is_enable_dt(pdev, "gate_aclk_fimc_bns_a");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_bnsa_345", 345 * 1000000);

	/* BNS B */
	fimc_is_enable_dt(pdev, "gate_aclk_fimc_bns_b");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_bnsb_345", 345 * 1000000);

	/* BNS D */
	fimc_is_enable_dt(pdev, "gate_aclk_fimc_bns_d");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_bnsd_345", 345 * 1000000);

	/* CSIS1 */
	fimc_is_enable_dt(pdev, "gate_aclk_csis1_i_wrap");

	/* 3AA0 */
	fimc_is_enable_dt(pdev, "gate_aclk_fimc_3aa0");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_3aa0_345", 345 * 1000000);

	/* 3AA1 */
	fimc_is_enable_dt(pdev, "gate_aclk_fimc_3aa1");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_3aa1_234", 234 * 1000000);

	/* TREX */
	fimc_is_enable_dt(pdev, "gate_aclk_trex_a_5x1");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_trex_266", 266 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam0_trex_133", 133 * 1000000);
	...
	/* PHY .. */
	/*
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam0_nocp_133", "aclk_cam0_nocp_133");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs0_s2a", "phyclk_rxbyteclkhs0_s2a");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs0_s4", "phyclk_rxbyteclkhs0_s4");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs1_s4", "phyclk_rxbyteclkhs1_s4");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs2_s4", "phyclk_rxbyteclkhs2_s4");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs3_s4", "phyclk_rxbyteclkhs3_s4");*/

	return 0;
}

int exynos7420_cfg_clk_cam1(struct platform_device *pdev)
{
	/* VRA */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_sclvra_491", "aclk_cam1_sclvra_491");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam1_sclvra_246", 246 * 1000000);

	/* CORTEX */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_arm_668", "aclk_cam1_arm_668");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_cam1_arm_167", 167 * 1000000);

	/* BUSPERI */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_busperi_334", "aclk_cam1_busperi_334");
	...
	/* BNS C */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_bnscsis_133", "aclk_cam1_bnscsis_133");

	/* PHY .. */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_nocp_133", "aclk_cam1_nocp_133");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_cam1_trex_532", "aclk_cam1_trex_532");
	fimc_is_set_parent_dt(pdev, "mout_user_mux_phyclk_hs0_csis2_rx_byte", "phyclk_hs0_csis2_rx_byte");

	return 0;
}

int exynos7420_cfg_clk_isp0(struct platform_device *pdev)
{
	/* ISP0 */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_isp0_isp0_590", "aclk_isp0_isp0_590");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_isp0_isp0_295", 295 * 1000000);

	/* TPU */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_isp0_tpu_590", "aclk_isp0_tpu_590");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_isp0_tpu_295", 295 * 1000000);

	/* TREX */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_isp0_trex_532", "aclk_isp0_trex_532");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_isp0_trex_266", 266 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_isp0_trex_133", 133 * 1000000);

	return 0;
}

int exynos7420_cfg_clk_isp1(struct platform_device *pdev)
{
	/* ISP1 */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_isp1_isp1_468", "aclk_isp1_isp1_468");
	fimc_is_set_rate_dt(pdev, "dout_clkdiv_pclk_isp1_isp1_234", 234 * 1000000);

	/* ETC */
	fimc_is_set_parent_dt(pdev, "mout_user_mux_aclk_isp1_ahb_117", "aclk_isp1_ahb_117");
...
int exynos7420_fimc_is_clk_on(struct platform_device *pdev)
{
	...
	/* BUS0 */
	fimc_is_enable_dt(pdev, "gate_aclk_lh_cam0");
	fimc_is_enable_dt(pdev, "gate_aclk_lh_cam1");
	fimc_is_enable_dt(pdev, "gate_aclk_lh_isp");
	fimc_is_enable_dt(pdev, "gate_aclk_noc_bus0_nrt");

	/* CAM0 */
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam0_csis0_690");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam0_bnsa_690");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam0_bnsb_690");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam0_bnsd_690");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam0_csis1_174");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam0_3aa0_690");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam0_3aa1_468");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam0_trex_532");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam0_nocp_133");
	fimc_is_enable_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs0_s2a");
	fimc_is_enable_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs0_s4");
	fimc_is_enable_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs1_s4");
	fimc_is_enable_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs2_s4");
	fimc_is_enable_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs3_s4");
	...
	/* CAM1 */
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam1_sclvra_491");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam1_arm_668");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam1_busperi_334");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam1_bnscsis_133");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam1_nocp_133");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_cam1_trex_532");
	fimc_is_enable_dt(pdev, "mout_user_mux_sclk_isp_spi0");
	fimc_is_enable_dt(pdev, "mout_user_mux_sclk_isp_spi1");
	fimc_is_enable_dt(pdev, "mout_user_mux_sclk_isp_uart");
	fimc_is_enable_dt(pdev, "mout_user_mux_phyclk_hs0_csis2_rx_byte");
	...
	/* ISP0 */
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_isp0_isp0_590");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_isp0_tpu_590");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_isp0_trex_532");
	...
	/* ISP1 */
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_isp1_isp1_468");
	fimc_is_enable_dt(pdev, "mout_user_mux_aclk_isp1_ahb_117");
	...
	PRINT_CLK(EXYNOS7420_DIV_BUS0, "DIV0");
...
int exynos7420_fimc_is_clk_off(struct platform_device *pdev)
{
	...
	/* BUS0 */
	fimc_is_disable_dt(pdev, "gate_aclk_lh_cam0");
	fimc_is_disable_dt(pdev, "gate_aclk_lh_cam1");
	fimc_is_disable_dt(pdev, "gate_aclk_lh_isp");
	fimc_is_disable_dt(pdev, "gate_aclk_noc_bus0_nrt");

	/* CAM0 */
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam0_csis0_690");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam0_bnsa_690");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam0_bnsb_690");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam0_bnsd_690");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam0_csis1_174");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam0_3aa0_690");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam0_3aa1_468");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam0_trex_532");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam0_nocp_133");
	fimc_is_disable_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs0_s2a");
	fimc_is_disable_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs0_s4");
	fimc_is_disable_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs1_s4");
	fimc_is_disable_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs2_s4");
	fimc_is_disable_dt(pdev, "mout_user_mux_phyclk_rxbyteclkhs3_s4");

	/* CAM1 */
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam1_sclvra_491");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam1_arm_668");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam1_busperi_334");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam1_bnscsis_133");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam1_nocp_133");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_cam1_trex_532");
	fimc_is_disable_dt(pdev, "mout_user_mux_sclk_isp_spi0");
	fimc_is_disable_dt(pdev, "mout_user_mux_sclk_isp_spi1");
	fimc_is_disable_dt(pdev, "mout_user_mux_sclk_isp_uart");
	fimc_is_disable_dt(pdev, "mout_user_mux_phyclk_hs0_csis2_rx_byte");

	/* ISP0 */
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_isp0_isp0_590");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_isp0_tpu_590");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_isp0_trex_532");

	/* ISP1 */
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_isp1_isp1_468");
	fimc_is_disable_dt(pdev, "mout_user_mux_aclk_isp1_ahb_117");
...
/* sequence is important, don't change order */
int exynos7420_fimc_is_sensor_power_on(struct platform_device *pdev, int sensor_id)
{
	pr_debug("%s\n", __func__);
...
/* sequence is important, don't change order */
int exynos7420_fimc_is_sensor_power_off(struct platform_device *pdev, int sensor_id)
{
	pr_debug("%s\n", __func__);
...
int exynos7420_fimc_is_print_pwr(struct platform_device *pdev)
{
	pr_debug("%s\n", __func__);

	pr_info("ISP power state(0x%08x)\n", readl(EXYNOS7420_ISP0_STATUS));
	pr_info("ISP power state(0x%08x)\n", readl(EXYNOS7420_ISP1_STATUS));
	pr_info("CAM0 power state(0x%08x)\n", readl(EXYNOS7420_CAM0_STATUS));
	pr_info("CAM1 power state(0x%08x)\n", readl(EXYNOS7420_CAM1_STATUS));

	return 0;
}

int exynos7420_fimc_is_print_clkout(int cmu_blk)
{
	writel(0x700, EXYNOS7420_PMU_DEBUG);
#if 0
	switch(cmu_blk){
		/* TOPC */
		case CLKOUT_CMU_TOPC:
			writel(0x10000, EXYNOS7420_CLKOUT_ALL_BLK_CMU);
			writel(0x10900, EXYNOS7420_CLKOUT_CMU_TOPC);
			break;
			/* TOP0 */
		case CLKOUT_CMU_TOP0:
			writel(0x10001, EXYNOS7420_CLKOUT_ALL_BLK_CMU);
			writel(0x10900, EXYNOS7420_CLKOUT_CMU_TOP0);
			pr_info("dan : top0\n");
			break;
			/* CAM0 */
		case CLKOUT_CMU_CAM0:
			writel(0x10014, EXYNOS7420_CLKOUT_ALL_BLK_CMU);
			writel(0x10900, EXYNOS7420_CLKOUT_CMU_CAM0);
			pr_info("dan : top0\n");
			break;
			/* CAM1 */
		case CLKOUT_CMU_CAM1:
			writel(0x10015, EXYNOS7420_CLKOUT_ALL_BLK_CMU);
			writel(0x10900, EXYNOS7420_CLKOUT_CMU_CAM1);
			pr_info("dan : top0\n");
			break;
			/* ISP0 */
		case CLKOUT_CMU_ISP0:
			writel(0x10018, EXYNOS7420_CLKOUT_ALL_BLK_CMU);
			writel(0x10900, EXYNOS7420_CLKOUT_CMU_ISP0);
			pr_info("dan : top0\n");
			break;
			/* ISP1 */
		case CLKOUT_CMU_ISP1:
			writel(0x10019, EXYNOS7420_CLKOUT_ALL_BLK_CMU);
			writel(0x10900, EXYNOS7420_CLKOUT_CMU_ISP1);
			pr_info("dan : top0\n");
			break;
	}
#endif
...
#elif defined(CONFIG_SOC_EXYNOS7420)
	exynos7420_cfg_clk_sclk(pdev);
	exynos7420_cfg_clk_cam1(pdev);
#endif
	return 0;
}
...
#elif defined(CONFIG_SOC_EXYNOS7420)
	exynos7420_fimc_is_sensor_power_on(pdev, sensor_id);
#endif
	return 0;
}
...
#elif defined(CONFIG_SOC_EXYNOS7420)
	exynos7420_fimc_is_sensor_power_off(pdev, sensor_id);
#endif
	return 0;
}
...
#elif defined(CONFIG_SOC_EXYNOS7420)
	exynos7420_fimc_is_print_pwr(pdev);
#endif
	return 0;
}
