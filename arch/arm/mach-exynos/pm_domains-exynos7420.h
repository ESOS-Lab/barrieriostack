...
void __iomem *lpi_mask_cam1_asyncbridge;
...
static struct exynos7420_pd_data pd_data_list[] = {
	{
		...
		.name = "pd-g2d",
		.top_clks = top_clks_g2d,
		.local_clks = local_clks_g2d,
		.sys_pwr_regs = sys_pwr_regs_g2d,
		.save_list = save_list_g2d,
		.num_top_clks = ARRAY_SIZE(top_clks_g2d),
		.num_local_clks = ARRAY_SIZE(local_clks_g2d),
		.num_sys_pwr_regs = ARRAY_SIZE(sys_pwr_regs_g2d),
		.num_save_list = ARRAY_SIZE(save_list_g2d),
	}, {
		.name = "pd-mscl",
		...
		.name = "pd-hevc",
		.top_clks = top_clks_hevc,
		.local_clks = local_clks_hevc,
		.sys_pwr_regs = sys_pwr_regs_hevc,
		.save_list = save_list_hevc,
		.num_top_clks = ARRAY_SIZE(top_clks_hevc),
		.num_local_clks = ARRAY_SIZE(local_clks_hevc),
		.num_sys_pwr_regs = ARRAY_SIZE(sys_pwr_regs_hevc),
		.num_save_list = ARRAY_SIZE(save_list_hevc),
	},
};
