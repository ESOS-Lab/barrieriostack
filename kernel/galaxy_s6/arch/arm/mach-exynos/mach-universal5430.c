...
static void __init universal5430_dt_machine_init(void)
{
	of_platform_populate(NULL, of_default_bus_match_table, NULL, NULL);
}

static char const *universal5430_dt_compat[] __initdata = {
	"samsung,exynos5430",
	NULL
};

static void __init universal5430_reserve(void)
{
#ifdef CONFIG_MIPI_LLI
	/* mipi-lli */
...
DT_MACHINE_START(UNIVERSAL5430, "UNIVERSAL5430")
	.init_irq	= exynos5_init_irq,
	.smp		= smp_ops(exynos_smp_ops),
	.map_io		= universal5430_dt_map_io,
	.init_machine	= universal5430_dt_machine_init,
	.init_late	= exynos_init_late,
	.init_time	= exynos_init_time,
	.dt_compat	= universal5430_dt_compat,
	.restart        = exynos5_restart,
	.reserve	= universal5430_reserve,
MACHINE_END
