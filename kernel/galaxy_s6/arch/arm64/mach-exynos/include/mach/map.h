...
#define EXYNOS7420_VA_PMU_LPI_CAM0	(S5P_VA_PMU + SZ_64K + (SZ_4K * 0))
#define EXYNOS7420_VA_PMU_LPI_CAM1	(S5P_VA_PMU + SZ_64K + (SZ_4K * 1))
#define EXYNOS7420_VA_PMU_LPI_ISP0	(S5P_VA_PMU + SZ_64K + (SZ_4K * 2))
#define EXYNOS7420_VA_PMU_LPI_ATLAS	(S5P_VA_PMU + SZ_64K + (SZ_4K * 3))

#define EXYNOS7420_VA_PMU_LPI_MIF0	(S5P_VA_PMU + SZ_64K + (SZ_4K * 4))
#define EXYNOS7420_VA_PMU_LPI_MIF1	(S5P_VA_PMU + SZ_64K + (SZ_4K * 5))
#define EXYNOS7420_VA_PMU_LPI_MIF2	(S5P_VA_PMU + SZ_64K + (SZ_4K * 6))
#define EXYNOS7420_VA_PMU_LPI_MIF3	(S5P_VA_PMU + SZ_64K + (SZ_4K * 7))
