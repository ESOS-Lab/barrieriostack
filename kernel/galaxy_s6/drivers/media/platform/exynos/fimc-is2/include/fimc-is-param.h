...
#else
#define PARAM_TAALG_AE_CONFIG   INC_NUM(PARAM_SENSOR_DMA_OUTPUT)         //0x0000 0040
#define PARAM_TAALG_RESERVED1   INC_NUM(PARAM_TAALG_AE_CONFIG)         //0x0000 0080
#define PARAM_TAALG_RESERVED2   INC_NUM(PARAM_TAALG_RESERVED1)         //0x0000 0100
#define PARAM_3AA_CONTROL           INC_NUM(PARAM_TAALG_RESERVED2)    //0x0000 0200
#endif
...
#else
#define PARAM_STRNUM_TAALG           (PARAM_TAALG_AE_CONFIG)
#define PARAM_RANGE_TAALG            3
#endif
